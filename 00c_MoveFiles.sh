...
#SBATCH -o ./errors/move_files_%A_%a.out
#SBATCH -e ./errors/move_files_%A_%a.err
#SBATCH --mail-type=END

#cp -r /n/holyscratch01/wofsy_lab/Lab/MethaneAIR_Forward_Model/wrf/template /n/holylfs04/LABS/wofsy_lab/Lab/MethaneAIR_Forward_Model/wrf_archive/

#cp -r /n/holyscratch01/wofsy_lab/Lab/MethaneAIR_Forward_Model/flexpart/data/template /n/holylfs04/LABS/wofsy_lab/Lab/MethaneAIR_Forward_Model/flexpart_archive/

#cp -r /n/holyscratch01/wofsy_lab/Lab/MethaneAIR_Forward_Model/flexpart/config /n/holylfs04/LABS/wofsy_lab/Lab/MethaneAIR_Forward_Model/wrf_archive/


#cp -r /n/holyscratch01/wofsy_lab/Lab/MethaneAIR_Forward_Model/flexpart/patches /n/holylfs04/LABS/wofsy_lab/Lab/MethaneAIR_Forward_Model/wrf_archive/

#cp -r /n/holyscratch01/wofsy_lab/Lab/MethaneAIR_Forward_Model/flexpart/Readme.md /n/holylfs04/LABS/wofsy_lab/Lab/MethaneAIR_Forward_Model/wrf_archive/

#cp -r /n/holyscratch01/wofsy_lab/Lab/MethaneAIR_Forward_Model/flexpart/src_debug /n/holylfs04/LABS/wofsy_lab/Lab/MethaneAIR_Forward_Model/wrf_archive/
...
#CONFIG="config_MX037_Uinta.json"
...
#singularity exec /n/holylfs04/LABS/wofsy_lab/Everyone/geospatial_latest_0.sif Rscript 00_BuildDirectories.R $CONFIG
