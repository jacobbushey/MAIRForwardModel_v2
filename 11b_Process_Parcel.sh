...
#SBATCH -o errors/11_process_parcel_%A_%a.out
#SBATCH -e errors/11_process_parcel_%A_%a.err
...
singularity exec /n/holylfs04/LABS/wofsy_lab/Everyone/geospatial_latest_0.sif Rscript 11a_Process_Parcel.R $CONFIG
