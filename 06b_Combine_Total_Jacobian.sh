#!/bin/bash
#
#SBATCH -J combine_jacobian
#SBATCH -p serial_requeue
#SBATCH -c 1
#SBATCH -t 0-02:00
#SBATCH --mem-per-cpu 128000
#SBATCH --constraint intel
#SBATCH -o ./errors/06_combine_%A_%a.out
#SBATCH -e ./errors/06_combine_%A_%a.err
#SBATCH --mail-type=END

# Usage------------------------------------------------------------------------

# sbatch 06b_Construct_Jacobian.sh
...
singularity exec /n/holylfs04/LABS/wofsy_lab/Everyone/geospatial_latest_0.sif Rscript 06a_Combine_Total_Jacobian.R $CONFIG
