#!/bin/bash
#
#SBATCH -J averaging_kernel_MX025
#SBATCH -p huce_ice
#SBATCH -c 1
#SBATCH -t 0-02:00
#SBATCH --mem-per-cpu 64000
#SBATCH --constraint intel
#SBATCH -o ./errors/analyze_%A_%a.out
#SBATCH -e ./errors/analyze_%A_%a.err
...
#CONFIG="config_TEST000.json"
#CONFIG="config_RF07_Midland.json"
#CONFIG="config_RF07_Delaware.json"
#CONFIG="config_MX007.json"

#CONFIG="config_RF07_Midland_OSSE.json"
#CONFIG="config_RF07_Delaware_OSSE.json"
...
singularity exec /n/holylfs04/LABS/wofsy_lab/Everyone/geospatial_latest_0.sif Rscript 17a_Averaging_Kernel.R $CONFIG
