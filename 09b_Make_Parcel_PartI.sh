#!/bin/bash
#
#SBATCH -J make_parcel_parti
#SBATCH -p huce_ice
#SBATCH -c 1
#SBATCH -t 0-02:00
#SBATCH --mem-per-cpu 128000
#SBATCH --constraint intel
#SBATCH -o ./errors/09_parti_%A_%a.out
#SBATCH -e ./errors/09_parti_%A_%a.err
#SBATCH --mail-type=END

# Usage------------------------------------------------------------------------

# sbatch 09b_Make_Parcel.sh [config file]
...
singularity exec /n/holylfs04/LABS/wofsy_lab/Everyone/geospatial_latest_0.sif Rscript 09a_Make_Parcel_PartI.R $CONFIG
