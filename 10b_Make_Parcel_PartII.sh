...
#SBATCH -o ./errors/10_partii_%A_%a.out
#SBATCH -e ./errors/10_partii_%A_%a.err
...
singularity exec /n/holylfs04/LABS/wofsy_lab/Everyone/geospatial_latest_0.sif Rscript 10a_Make_Parcel_PartII.R $CONFIG
